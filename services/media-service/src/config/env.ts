...
const envSchema = z.object({
  ...
  PORT: z.string().default('3004').transform(val => parseInt(val)),
  ...
  KAFKA_CLIENT_ID: z.string().default('media-service'),
  KAFKA_BROKER: z.string().default('kafka-9c33e1e-haluk7862-58ab.g.aivencloud.com:18253'),
  KAFKA_CONSUMER_GROUP_ID: z.string().default('media-service-group'),
